...
it('I18n select correctly', function () {
  _index2.default.useLocale('ja');
  var data = {
    'en-US': 'English',
    'zh-Hans': '简体中文',
  ...
  expect(_index2.default.select(data)).toEqual(undefined);

  _index2.default.useLocale('en-US');
  expect(_index2.default.select(data)).toEqual('English');

  _index2.default.useLocale('zh-Hans');
  expect(_index2.default.select(data)).toEqual('简体中文');

  _index2.default.useLocale('zh-Hant');
  expect(_index2.default.select(data)).toEqual('繁體中文');
});